...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => fetchMessages()), await __temp, __restore();
    if (!chatFromChats.value) {
      [__temp, __restore] = withAsyncContext(() => navigateTo("/", { replace: true })), await __temp, __restore();
    }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layers/chat/app/pages/chats/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_id_-B17iGsTV.mjs.map
