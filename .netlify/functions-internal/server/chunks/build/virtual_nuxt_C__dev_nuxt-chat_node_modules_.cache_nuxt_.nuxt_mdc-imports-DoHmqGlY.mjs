...
const highlight = { "theme": "material-theme-palenight" };

export { highlight, rehypePlugins, remarkPlugins };
//# sourceMappingURL=virtual_nuxt_C__dev_nuxt-chat_node_modules_.cache_nuxt_.nuxt_mdc-imports-DoHmqGlY.mjs.map
